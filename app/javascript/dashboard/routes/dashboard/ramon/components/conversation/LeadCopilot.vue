  ...
  >
    ...
    <div class="flex flex-wrap items-center gap-1.5 mt-2.5">
      <button
        ...
        class="px-3 py-1 text-[11.5px] font-semibold rounded-[7px] bg-n-iris-9/10 text-n-iris-11 hover:bg-[#c9a97c]/[.22] disabled:opacity-40 disabled:cursor-not-allowed"
