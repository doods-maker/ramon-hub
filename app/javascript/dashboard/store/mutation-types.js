export default {
  ...
  SET_LEAD_SELECTION: 'SET_LEAD_SELECTION',
  SET_DOCK_CONVERSATION: 'SET_DOCK_CONVERSATION',
  SET_LEAD_STAGES: 'SET_LEAD_STAGES',
  ADD_LEAD_STAGE: 'ADD_LEAD_STAGE',
  EDIT_LEAD_STAGE: 'EDIT_LEAD_STAGE',
  DELETE_LEAD_STAGE: 'DELETE_LEAD_STAGE',
  SET_BENEFIT_TYPES: 'SET_BENEFIT_TYPES',
  ADD_BENEFIT_TYPE: 'ADD_BENEFIT_TYPE',
  EDIT_BENEFIT_TYPE: 'EDIT_BENEFIT_TYPE',
  DELETE_BENEFIT_TYPE: 'DELETE_BENEFIT_TYPE',
  SET_LEAD_PRIORITIES: 'SET_LEAD_PRIORITIES',
  ADD_LEAD_PRIORITY: 'ADD_LEAD_PRIORITY',
  EDIT_LEAD_PRIORITY: 'EDIT_LEAD_PRIORITY',
  DELETE_LEAD_PRIORITY: 'DELETE_LEAD_PRIORITY',

  // Ramon — Tarefas do lead (cadência)
  SET_LEAD_TASKS_UI_FLAG: 'SET_LEAD_TASKS_UI_FLAG',
  MERGE_LEAD_TASKS: 'MERGE_LEAD_TASKS',
  MERGE_LEAD_TASK: 'MERGE_LEAD_TASK',
  DELETE_LEAD_TASK: 'DELETE_LEAD_TASK',

  // Ramon — Centro de Comando (dashboard agregado)
  SET_RAMON_DASHBOARD_UI_FLAG: 'SET_RAMON_DASHBOARD_UI_FLAG',
  SET_RAMON_DASHBOARD: 'SET_RAMON_DASHBOARD',

  // Ramon — Copiloto noturno
  SET_COPILOT_SUGGESTIONS_UI_FLAG: 'SET_COPILOT_SUGGESTIONS_UI_FLAG',
  SET_COPILOT_SUGGESTIONS: 'SET_COPILOT_SUGGESTIONS',
  DELETE_COPILOT_SUGGESTION: 'DELETE_COPILOT_SUGGESTION',
  DELETE_COPILOT_SUGGESTIONS: 'DELETE_COPILOT_SUGGESTIONS',

  // Ramon — Teses
  SET_THESES_UI_FLAG: 'SET_THESES_UI_FLAG',
  SET_THESES: 'SET_THESES',
  ADD_THESIS: 'ADD_THESIS',
  EDIT_THESIS: 'EDIT_THESIS',
  DELETE_THESIS: 'DELETE_THESIS',

  // Ramon — Agentes de triagem
  SET_TRIAGE_AGENTS_UI_FLAG: 'SET_TRIAGE_AGENTS_UI_FLAG',
  SET_TRIAGE_AGENTS: 'SET_TRIAGE_AGENTS',
  ADD_TRIAGE_AGENT: 'ADD_TRIAGE_AGENT',
  EDIT_TRIAGE_AGENT: 'EDIT_TRIAGE_AGENT',
  DELETE_TRIAGE_AGENT: 'DELETE_TRIAGE_AGENT',
