...
SELECT b.conversation_id, b.account_id, b.inbox_id, b.iniciada_em, b.primeira_resposta_em,
       CASE WHEN b.primeira_resposta_em >= b.iniciada_em
            THEN ROUND(EXTRACT(EPOCH FROM (b.primeira_resposta_em - b.iniciada_em)) / 60.0, 1) END AS minutos_primeira_resposta,
